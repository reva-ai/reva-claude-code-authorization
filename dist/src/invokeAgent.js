...
function buildInvokeAgentRequest(userEmail, agentId, prompt, session, activeSessionCount = 0, currentSession) {
    ...
    return {
        ...
        context: (0, context_1.buildInvokeAgentContext)(activeSessionCount, currentSession),
